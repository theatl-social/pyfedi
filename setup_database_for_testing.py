...
def create_minimal_database():
    ...
    try:
        ...
        topics_data = [
            # Top-level topics
            (1, 'Technology', 'technology', None, 3, True, 'https://localhost/t/technology'),
            ...
            (5, 'Programming', 'programming', 1, 2, True, 'https://localhost/t/programming'),
            (6, 'Web Development', 'web-dev', 1, 1, True, 'https://localhost/t/web-dev'),
            (7, 'Mobile Development', 'mobile-dev', 1, 1, True, 'https://localhost/t/mobile-dev'),
            ...
            (11, 'Photography', 'photography', 4, 1, True, 'https://localhost/t/photography'),
            
            # Sub-sub-topics
            (12, 'Python', 'python', 5, 1, True, 'https://localhost/t/python'),
            (13, 'JavaScript', 'javascript', 5, 1, True, 'https://localhost/t/javascript'),
        ]
        ...
        communities_data = [
            (1, 'python', 'Python Programming', 'Discussion about Python programming language', 12),
            (2, 'javascript', 'JavaScript Development', 'JavaScript coding and frameworks', 13),
        ...
        with app.app_context():
            ...
            for item in tree:
                ...
                for child in children:
                    ...
                    print(f"      └─ {child['topic'].name} ({len(sub_children)} sub-children)")
