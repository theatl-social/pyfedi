    ...
    try:
        ...
        mock_topics = [
                ...
                "children": [
                    {
                        ...
                        "children": [
                            {
                                "topic": MockTopic(12, "Python", "python", 1),
                                "children": [],
                            },
                            {
                                "topic": MockTopic(13, "JavaScript", "javascript", 1),
                                "children": [],
                            },
                        ],
                    },
                    {
                        "topic": MockTopic(6, "Web Development", "web-dev", 1),
                        "children": [],
                    },
                    {
                        "topic": MockTopic(7, "Mobile Development", "mobile-dev", 1),
                        "children": [],
                    },
                ],
            },
            ...
            },
            {
                ...
                "children": [
                    {
                        "topic": MockTopic(10, "PC Gaming", "pc-gaming", 1),
                        "children": [],
                    }
                ],
            },
            {
                ...
                "children": [
                    {
                        "topic": MockTopic(11, "Photography", "photography", 1),
                        "children": [],
                    }
                ],
            },
        ...
        try:
            ...
            if len(topic_names_found) == 0:
                print(
                    "   ❌ No topics found in rendered output - container would be empty!"
                )
                return False
