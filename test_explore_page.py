            ...
            with app.test_client() as client:
                ...
                if response.status_code == 200:
                    ...
                    if 'len(topics)' in html_content:
                        print("   ❌ CRITICAL: Still using len(topics) instead of topics|length filter!")
                        return False
                    else:
                    ...
                    if success_rate >= 75:
                        print("✅ EXPLORE PAGE IS WORKING! Topics are being displayed correctly.")
                        return True
                    else:
                        print("❌ Explore page has issues - not all topics are displayed")
                        return False
                        
                else:
                    print(f"   ❌ Failed to load explore page: HTTP {response.status_code}")
