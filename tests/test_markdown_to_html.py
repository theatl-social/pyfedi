...
"""
    ...
    def test_em_dash(self):
        ...
        markdown = (
            "Em-dashes are fairly idiosyncratic---strange, really---to use regularly."
        )
        result = markdown_to_html(markdown, test_env={"fn_string": "fn-test"})
        self.assertEqual(
            "<p>Em-dashes are fairly idiosyncratic—strange, really—to use regularly.</p>\n",
            result,
        )
    ...
    def test_ignore_smartypants_code_block(self):
        ...
        result = markdown_to_html(markdown, test_env={"fn_string": "fn-test"})
        self.assertEqual(
            "<pre><code>No en--dash, nor em---dash, nor ellipsis... here.\n</code></pre>\n",
            result,
        )
    ...
    def test_lemmy_autocomplete_multiple_links(self):
        ...
        result = markdown_to_html(markdown, test_env={"fn_string": "fn-test"})
        self.assertEqual(
            "<p>Check out !community@instance.tld and @user@instance.tld</p>\n", result
        )
    ...
    def test_footnotes(self):
        ...
        # Note: With on_newline: True in markdown config, single newlines become <br/>
