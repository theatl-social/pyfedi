...
class TestDudupePostIds(unittest.TestCase):
    ...
    def test_no_cross_posts_found(self, mock_low_value):
        ...
        params = [
            (
                ...
                100,
                5,
            ),  # Cross-post ID 99 doesn't exist in params, but post 1 is in visible list
            (2, None, 101, 10),
        ]
        result = dedupe_post_ids(params, limit_to_visible=False)
    ...
    def test_low_value_reposter_ignored_not_all_view(self, mock_low_value):
        ...
        params = [
            (
                ...
                100,
                5,
            ),  # Low-value reposter post (would normally be deprioritized)
            (2, [1, 3], 101, 10),  # Cross-post 1 (10 replies)
            (
                3,
                [1, 2],
                102,
                15,
            ),  # Cross-post 2 (15 replies) - should win since it's visible and has most replies
        ]
        result = dedupe_post_ids(params, limit_to_visible=True)
        self.assertEqual(
            result, [3]
        )  # Post 3 should win because alternatives are visible and it has most replies
    ...
    def test_mixed_scenarios_not_all_view(self, mock_low_value):
        ...
        params = [
            ...
            (
                ...
                201,
                20,
            ),  # Cross-post 1 (20 replies) - should win since it's visible and has most replies
            (7, [5, 6], 202, 15),  # Cross-post 2 (15 replies)
        ]
        result = dedupe_post_ids(params, limit_to_visible=True)
        # Regular post, best from first group (12 replies), best from second group (20 replies)
    ...
    def test_limit_to_visible_true_with_invisible_alternatives(self, mock_low_value):
        ...
        params = [
            (
                ...
                100,
                5,
            ),  # Low-value reposter post, cross-posts 2,3 not in visible list
    ...
    def test_limit_to_visible_false_with_invisible_alternatives(self, mock_low_value):
        ...
        params = [
            (
                ...
                100,
                5,
            ),  # Low-value reposter post, cross-posts 99,98 not in visible list
        ]
        result = dedupe_post_ids(params, limit_to_visible=False)
    ...
    def test_limit_to_visible_mixed_visibility(self, mock_low_value):
        ...
        params = [
            (
                ...
                100,
                5,
            ),  # Low-value reposter, cross-post 2 visible, 99 invisible
    ...
    def test_bug_non_bot_ignores_reply_count(self, mock_low_value):
        ...
        params = [
            ...
            (
                ...
                102,
                100,
            ),  # Cross-post with 100 replies - SHOULD win but doesn't
        ]
        result = dedupe_post_ids(params, limit_to_visible=False)
        ...
        self.assertEqual(
            result,
            [3],
            "Post with most replies should be chosen, not first encountered",
        )
    ...
    def test_bug_non_bot_ignores_reply_count_limit_visible(self, mock_low_value):
        ...
        params = [
            (
                ...
                100,
                10,
            ),  # Regular user post with 10 replies (encountered first)
            ...
            (
                ...
                102,
                150,
            ),  # Cross-post with 150 replies - SHOULD win but doesn't
        ]
        result = dedupe_post_ids(params, limit_to_visible=True)
        # BUG: Current behavior returns [1] (first post wins)
        # EXPECTED: Should return [3] (post with most replies should win)
        self.assertEqual(
            result,
            [3],
            "Post with most replies should be chosen even when limit_to_visible=True",
        )
    ...
    def test_bug_multiple_cross_post_groups_non_bot(self, mock_low_value):
        ...
        self.assertEqual(
            result,
            [3, 6, 7],
            "Posts with most replies should be chosen in each cross-post group",
        )
    ...
    def test_bug_mixed_bots_and_non_bots(self, mock_low_value):
        ...
        self.assertEqual(
            result,
            [3, 6],
            "Bots should be replaced by non-bots, and highest reply count should win",
        )
    ...
    def test_bot_with_only_bot_alternatives(self, mock_low_value):
        ...
        self.assertEqual(
            result, [3], "When all alternatives are bots, choose bot with most replies"
        )
    ...
    def test_bot_deprioritization_basic(self, mock_low_value):
        ...
        params = [
            ...
            (
                ...
                101,
                5,
            ),  # Non-bot with 5 replies - should win despite fewer replies
        ]
        result = dedupe_post_ids(params, limit_to_visible=False)
        ...
        self.assertEqual(
            result,
            [2],
            "Non-bot should be preferred over bot regardless of reply count",
        )
    ...
    def test_bot_deprioritization_chooses_best_non_bot(self, mock_low_value):
        ...
        self.assertEqual(
            result, [3], "When replacing bot, choose non-bot with most replies"
        )
    ...
    def test_post_with_no_valid_alternatives_not_hidden(self, mock_low_value):
        ...
        self.assertEqual(
            result, [1, 2], "Posts with non-existent cross-posts should not be hidden"
        )
    ...
    def test_bot_post_with_no_valid_alternatives_not_hidden(self, mock_low_value):
        ...
        self.assertEqual(
            result, [1, 2], "Bot posts with no valid alternatives should not be hidden"
        )
    ...
    def test_bug_order_matters_for_non_bots(self, mock_low_value):
        ...
        self.assertEqual(
            result2,
            [1],
            "Should choose post with most replies (200) regardless of order",
        )
