...
class TestPrivateRegistrationEndpoint:
    ...
    def test_private_registration_success(self, client, auth_headers, sample_user_request):
    ...
    def test_private_registration_duplicate_user(self, client, auth_headers, sample_user_request):
