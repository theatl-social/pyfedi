...
def test_single_migration_head():
    ...
    with app.app_context():
        ...
        try:
            ...
            if len(heads) == 0:
                raise AssertionError("No migration heads found! Database migrations may be missing.")
            elif len(heads) > 1:
            ...
            raise AssertionError("Flask command not found. Ensure Flask is installed and in PATH.")
