...
def admin_federation():
    ...
    # this is the main settings form
        ...
        set_setting('auto_add_remote_instances', form.auto_add_remote_instances.data)
    ...
    # this is just the regular page load
        ...
        form.auto_add_remote_instances.data = get_setting('auto_add_remote_instances', True)
