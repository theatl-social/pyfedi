...
from app.activitypub.signature import RsaKeys, default_context, post_request
...
from app.community.util import save_banner_file, save_icon_file, search_for_community
...
def admin_site():
    ...
    if form.validate_on_submit():
        ...
        set_setting(
            "announcement_html",
            markdown_to_html(form.announcement.data, anchors_new_tab=False),
        )
...
def admin_misc():
    ...
    if close_form.submit.data and close_form.validate():
        ...
        if close_form.announcement.data:
            ...
            set_setting(
                "announcement_html",
                markdown_to_html(close_form.announcement.data, anchors_new_tab=False),
            )
        db.session.commit()
        flash(_("Settings saved."))
