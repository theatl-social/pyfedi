...
from sqlalchemy import Index, desc, or_, text
from sqlalchemy.dialects.postgresql import ARRAY, BIT, UUID
from sqlalchemy.exc import IntegrityError
from sqlalchemy.ext.mutable import MutableList
from sqlalchemy_searchable import SearchQueryMixin
from sqlalchemy_utils.types import (  # https://sqlalchemy-searchable.readthedocs.io/en/latest/installation.html
    TSVectorType,
)
from werkzeug.security import check_password_hash, generate_password_hash

from app import app_bcrypt, cache, celery, constants, db, httpx_client, login
...
class Post(db.Model):
    ...
    def new(
        ...
        post = Post(
            ...
            sticky=(
                request_json["object"]["stickied"]
                if "stickied" in request_json["object"]
                else False
            ),
            nsfw=(
                request_json["object"]["sensitive"]
                if "sensitive" in request_json["object"]
                else False
            ),
            nsfl=(
                request_json["object"]["nsfl"]
        ...
        if (
            ...
            if request_json["object"]["attachment"][0]["type"] == "Link":
                if "href" in request_json["object"]["attachment"][0]:
                    post.url = request_json["object"]["attachment"][0][
                        "href"
                    ]  # Lemmy < 0.19.4
            ...
            if (
                request_json["object"]["attachment"][0]["type"] == "Audio"
            ):  # WordPress podcast
