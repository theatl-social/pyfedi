# This file is part of PeachPie (fork of PieFed), which is licensed under the GNU General Public License (GPL) version 3.0.
...
# Celery removed - using Redis Streams instead
...
def create_app(config_class=Config):
    ...
    # Redis Streams configuration will be initialized here
