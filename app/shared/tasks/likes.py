...
@celery.task
def vote_for_post(user_id, post_id, vote_to_undo, vote_direction, federate: bool = True):
...
@celery.task
def vote_for_reply(user_id, reply_id, vote_to_undo, vote_direction, federate: bool = True):
