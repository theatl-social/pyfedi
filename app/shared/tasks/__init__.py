...
def task_selector(task_key, send_async=True, **kwargs):
    ...
    from app.shared.tasks.adds import add_mod, sticky_post
    ...
    from app.shared.tasks.notes import edit_reply, make_reply
    from app.shared.tasks.pages import edit_post, make_post
    from app.shared.tasks.removes import remove_mod, unsticky_post
