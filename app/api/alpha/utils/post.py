...
from app.post.util import get_comment_branch, post_replies
...
def get_post_list(auth, data, user_id=None, search_type="Posts") -> dict:
    ...
    community_id = (
        int(data["community_id"]) if data and "community_id" in data else None
    )
    ...
    community_name = (
        data["community_name"] if data and "community_name" in data else None
    )
...
def get_post_replies(auth, data):
    ...
    page_cursor = (
        data["page"] if data and "page" in data else None
