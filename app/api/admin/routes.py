...
@admin_bp.alt_response(
    400,
    schema=AdminPrivateRegistrationError,
    description="Validation error or user already exists",
)
@admin_bp.alt_response(
    401, schema=AdminPrivateRegistrationError, description="Invalid secret"
)
@admin_bp.alt_response(
    403,
    schema=AdminPrivateRegistrationError,
...
@admin_bp.alt_response(
    429, schema=AdminPrivateRegistrationError, description="Rate limit exceeded"
)
...
@admin_bp.alt_response(
    400, schema=AdminPrivateRegistrationError, description="Validation error"
)
@admin_bp.alt_response(
    401, schema=AdminPrivateRegistrationError, description="Invalid secret"
)
@admin_bp.alt_response(
    404, schema=AdminPrivateRegistrationError, description="User not found"
)
@require_private_registration_auth
...
@admin_bp.alt_response(
    400, schema=AdminPrivateRegistrationError, description="Invalid export request"
)
@require_private_registration_auth
