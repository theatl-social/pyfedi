...
def upgrade():
    ...
    with op.batch_alter_table("community_member", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_community_member_is_banned"), ["is_banned"], unique=False
        )

    with op.batch_alter_table("post", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_post_from_bot"), ["from_bot"], unique=False
        )
    ...
    with op.batch_alter_table("user", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_user_avatar_id"), ["avatar_id"], unique=False
        )
        batch_op.create_index(
            batch_op.f("ix_user_cover_id"), ["cover_id"], unique=False
        )
