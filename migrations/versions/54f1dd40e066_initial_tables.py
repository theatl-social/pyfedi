...
def upgrade():
    ...
    with op.batch_alter_table("user", schema=None) as batch_op:
        ...
        batch_op.create_index(
            batch_op.f("ix_user_user_name"), ["user_name"], unique=True
        )
    ...
    with op.batch_alter_table("activity_log", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_activity_log_timestamp"), ["timestamp"], unique=False
        )
        batch_op.create_index(
    ...
    with op.batch_alter_table("post", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_post_community_id"), ["community_id"], unique=False
        )
        batch_op.create_index(
            batch_op.f("ix_post_created_at"), ["created_at"], unique=False
        )
        batch_op.create_index(
            batch_op.f("ix_post_domain_id"), ["domain_id"], unique=False
        )
        batch_op.create_index(
            batch_op.f("ix_post_image_id"), ["image_id"], unique=False
        )
        batch_op.create_index(
            batch_op.f("ix_post_last_active"), ["last_active"], unique=False
        )
        batch_op.create_index(
            batch_op.f("ix_post_posted_at"), ["posted_at"], unique=False
        )
    ...
    with op.batch_alter_table("post_reply", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_post_reply_community_id"), ["community_id"], unique=False
        )
        batch_op.create_index(
            batch_op.f("ix_post_reply_created_at"), ["created_at"], unique=False
        )
        batch_op.create_index(
            batch_op.f("ix_post_reply_image_id"), ["image_id"], unique=False
        )
        batch_op.create_index(
            batch_op.f("ix_post_reply_post_id"), ["post_id"], unique=False
        )
        batch_op.create_index(
            batch_op.f("ix_post_reply_posted_at"), ["posted_at"], unique=False
        )
        batch_op.create_index(
            batch_op.f("ix_post_reply_score"), ["score"], unique=False
        )
        batch_op.create_index(
            batch_op.f("ix_post_reply_user_id"), ["user_id"], unique=False
        )
