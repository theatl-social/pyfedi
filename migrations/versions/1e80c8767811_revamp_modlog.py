...
def upgrade():
    ...
    with op.batch_alter_table('mod_log', schema=None) as batch_op:
        ...
        batch_op.create_index(batch_op.f('ix_mod_log_post_id'), ['post_id'], unique=False)
        batch_op.create_index(batch_op.f('ix_mod_log_reply_id'), ['reply_id'], unique=False)
        batch_op.create_index(batch_op.f('ix_mod_log_target_user_id'), ['target_user_id'], unique=False)
        batch_op.create_foreign_key('fk_mod_log_reply_id', 'post_reply', ['reply_id'], ['id'])
        batch_op.create_foreign_key('fk_mod_log_post_id', 'post', ['post_id'], ['id'])
        batch_op.create_foreign_key('fk_mod_log_target_user_id', 'user', ['target_user_id'], ['id'])
