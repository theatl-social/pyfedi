...
def upgrade():
    ...
    with op.batch_alter_table('scheduled_post', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_scheduled_post_community_id'), ['community_id'], unique=False)
        batch_op.create_index(batch_op.f('ix_scheduled_post_created_at'), ['created_at'], unique=False)
        batch_op.create_index(batch_op.f('ix_scheduled_post_domain_id'), ['domain_id'], unique=False)
        batch_op.create_index(batch_op.f('ix_scheduled_post_from_bot'), ['from_bot'], unique=False)
        batch_op.create_index(batch_op.f('ix_scheduled_post_image_id'), ['image_id'], unique=False)
        batch_op.create_index(batch_op.f('ix_scheduled_post_language_id'), ['language_id'], unique=False)
